package org.acme.hash_utils

import org.acme.hash_utils.StringUtils.encodeHex
import java.io.File
...
object HashUtils {
    ...
    fun getCheckSumFromFile(digest: MessageDigest, file: InputStream): String {
        val byteArray = updateDigest(digest, file).digest()
        val hexCode = encodeHex(byteArray, true)
        return String(hexCode)
    }
